...
print("Film: %s | id: %s | type: %s | genres: %s | startYear: %s | endYear: %s | runtimeMinutes: %s" % (film['originalTitle'], film['tconst'], film['titleType'], film['genres'], film['startYear'], film['endYear'], film['runtimeMinutes']))